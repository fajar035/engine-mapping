...
const GROUPS: GuideGroup[] = [
  ...
  {
    title: 'Injector & Pasokan Udara',
    note: 'Injector = penyemprot bensin. VE/ketinggian/suhu mengatur seberapa banyak udara yang dimodelkan masuk.',
    items: [
  ...
  {
    title: 'Grid Mapping',
    note: 'Membentuk kerangka tabel: batas atas putaran dan selisih antar baris. Kolom selalu mulai 1000 sesuai format JUKEN.',
    items: [
